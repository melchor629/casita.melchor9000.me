...
- 62d7f99: Change apollo telemetry implementation.
...
- ec7f414: Remove typeorm and type-graphql to use prisma and apollo with codegen.

### Patch Changes

- e718cd1: fixing dockerfiles
- ccaa89c: Update constraint directive to work with apollo directly
- Updated dependencies [ec7f414]
- Updated dependencies [e718cd1]
- Updated dependencies [3f0e08b]
  - @melchor629/fastify-infra@0.1.1
  - @melchor629/prisma-nas-auth@0.0.1
